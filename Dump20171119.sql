...
CREATE TABLE `task` (
  ...
  `dependency_task_id` varchar(64) DEFAULT '',
  `dependency_status` smallint(6) DEFAULT '1',
  `spec` varchar(64) DEFAULT NULL,
  `protocol` tinyint(4) NOT NULL,
  `command` varchar(256) NOT NULL,
  `timeout` mediumint(9) NOT NULL DEFAULT '0',
  `multi` tinyint(4) NOT NULL DEFAULT '1',
  `notify_status` smallint(6) DEFAULT '1',
  `notify_receiver` varchar(256) DEFAULT '',
...
-- Dump completed on 2017-11-19 17:57:18
